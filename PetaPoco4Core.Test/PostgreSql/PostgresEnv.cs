...
namespace PetaPoco4Core.Test.PostgreSql
{
    ...
    /// テスト共通
    /// </summary>
    public sealed class PostgresEnv: ITestCommon
    {
        // singleton instance
        private static readonly PostgresEnv _instance = new PostgresEnv();

        public static PostgresEnv Instance {  get { return _instance; } }
